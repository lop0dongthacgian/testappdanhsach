...
/* "Về trang chủ": đóng cửa sổ chi tiết đảng viên (không lưu thay đổi dở dang)
   và đưa danh sách về trạng thái mặc định - xoá tìm kiếm/lọc đang áp dụng
   (chỉ áp dụng cho admin, vì đảng viên không có ô tìm kiếm/lọc). */
function goHomeFromEditModal() {
  closeEditModal();
